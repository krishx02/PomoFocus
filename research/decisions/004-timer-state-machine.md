...
- Offline-First Sync Architecture — pending /tech-design. State persistence/rehydration uses timestamps to recover elapsed time.
- BLE Protocol — pending /tech-design. Device runs its own timer independently; sync conflicts deferred to that decision.
