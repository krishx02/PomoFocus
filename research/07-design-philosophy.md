# Design Philosophy — Grounded Principles for PomoFocus

> **Purpose:** A researched, cross-disciplinary design philosophy that grounds every visual, interaction, and material decision in PomoFocus. Synthesized from the most respected designers in digital product, industrial, and architectural design.
>
> **Core thesis:** The most powerful design doesn't ask people to learn something new. It gives them something they already know how to use — and makes them feel something they didn't expect.
...
**Background:** Head of design at Braun for over 30 years. Created some of the most influential consumer products of the 20th century. His work directly inspired Apple's design language under Jony Ive.
...
5. Good design is **unobtrusive** — products are tools, not decorative objects
6. Good design is **honest** — it does not promise more than it delivers
7. Good design is **long-lasting** — it avoids being fashionable and therefore never looks outdated
...
### 3. Naoto Fukasawa — "Without Thought"

**Background:** Industrial designer. Led IDEO Tokyo. Designed for MUJI, B&B Italia, Alessi, Maruni. Co-founded ±0 (Plus Minus Zero). Advisory board of MUJI.
...
- **Texture of use** — How a thing feels in your hand, on your desk, in your pocket. The sensory experience is part of the design, not separate from it.
...
**Why this matters for PomoFocus:** "Without Thought" is the operating principle for the device interaction model. The user picks up the device, sees their goal, presses a button, focuses. No onboarding. No manual. The action should feel like something they were already doing. And the device at rest on a desk should look calm and purposeful — it's "active rest."
...
- **Exformation** — The act of making things simpler to understand by removing what doesn't need to be communicated. The opposite of adding "information" — you add understanding by subtracting noise.
...
### 5. Jasper Morrison — "Super Normal"

**Background:** British industrial designer. Has designed for Vitra, Alessi, Flos, MUJI, Samsung, Emeco. Coined the term "Super Normal" with Naoto Fukasawa.
...
**Why this matters for PomoFocus:** The app should be "Super Normal." It should look like a timer app that everybody imagines when they think "timer app" — but better in every small detail. Not distinctive in screenshots. Distinctive in use.

---

### 6. Jony Ive — "Inevitable"

**Background:** Chief Design Officer at Apple (1996–2019). Led the design of the iMac, iPod, iPhone, iPad, MacBook, Apple Watch, and Apple Park. Now runs LoveFrom.
...
- **Material honesty** — Let materials be what they are. Glass should feel like glass. Aluminum should feel like aluminum. Don't disguise materials.
...
### 8. Teenage Engineering — Objects You Want to Touch

**Background:** Swedish design company. Created the OP-1 synthesizer, the Pocket Operators, the OB-4 speaker, the Computer-1 case, and the TP-7 tape recorder. Known for products that are playful, deeply functional, and impossible to put down.
...
### 9. Panic Inc. / Playdate — Charm as Design Strategy
...
4. **Learn** — Knowledge makes everything simpler (relate new to known)
...
8. **Trust** — In simplicity we trust (simple systems feel trustworthy)
...
**Relevance to PomoFocus:** The physical device should age well. If it's wood, let it patina. If it's aluminum, let it scratch. The data in the app — streaks broken, sessions abandoned — is wabi-sabi: the imperfection of real human effort is more beautiful than a perfect record. The app should never shame incomplete data.
...
### Scandinavian Design — Democratic Beauty
...
- **Lagom** — "Just the right amount." Not too much, not too little. The Scandinavian rejection of excess.

**Relevance to PomoFocus:** The free tier being a complete product is demokratisk design. The device and app should create hygge — a sense of warmth and calm in your workspace. Lagom is the interaction philosophy: just enough features, just enough data, just enough encouragement.

---

### Calm Technology — Respecting Attention
...
4. Technology should **amplify the best of both technology and humanity**
5. Technology can **communicate but doesn't need to speak** — ambient signals (light, vibration, position) over notifications
...
### "Quiet Luxury" — Quality Through Restraint
...
- **Insider recognition** — People who understand quality will recognize it. The product doesn't need to convince everyone.

**Relevance to PomoFocus:** The app should not have a splash screen with a logo animation. The device should not have branding on the front face. The quality should be in the details: the feel of the button, the readability of the e-ink text, the speed of BLE sync, the smoothness of the timer animation. Users should discover the quality rather than being told about it.

---

### Material Honesty — Let Things Be What They Are
...
## Part III: The Synthesized Philosophy

### PomoFocus Design Principles
...
## Part IV: Applying the Philosophy

### Decision Framework

When facing any design decision, run it through this sequence:

```
1. SHAKER TEST
   → Is this necessary? Is this useful?
   → If no to either: cut it.
   → If yes to both: proceed.

2. FAMILIARITY CHECK
   → Does the user already know how to use this?
   → If no: can you make it match an existing mental model?
   → If still no: is the new pattern simple enough to learn in <3 seconds?

3. MATERIAL TRUTH
   → Are you designing FOR this platform/medium, or DESPITE it?
   → Does it feel native to the material (e-ink, iOS, web, watchOS)?

4. EMPTINESS AUDIT
   → What can you remove without losing meaning?
   → Is every remaining element earning its space?

5. EMOTIONAL CHECK (Norman's Three Levels)
   → Visceral: Does it feel right before interaction? (shape, color, weight, first impression)
   → Behavioral: Does it work the way hands and minds expect? (interaction, feedback, flow)
   → Reflective: Does using it make the person feel good about themselves? (identity, story, aspiration)

6. CALM TECHNOLOGY TEST
   → Does this demand attention, or inform at the periphery?
   → Can the user glance rather than read?
   → Does the product respect the user's primary task (focusing)?

7. REST STATE
   → How does this look when inactive?
   → Does it improve the atmosphere of the space it occupies?
```
