...
| [10-self-healing-agents.md](./10-self-healing-agents.md)                           | Self-Healing Agents: Deep Research Synthesis          | 60+ sources across academic papers, OSS agents, commercial products, and adjacent fields. 6 universal patterns: desired-state reconciliation, immutable spec + mutable implementation, reversibility as safety primitive, budget-bounded exploration, escalation thresholds, derivative check. Powers self-healing skills and fix loops. |
